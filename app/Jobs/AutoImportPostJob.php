...
class AutoImportPostJob implements ShouldQueue
{
     ...
     * @return void
     */
    public function handle(PostService $postService, ImportService $importService)
    {
        ...
        if ($request->successful()) {
            ...
            // update the import next_execution_time
            $importService->updateNextExecutionTime($this->importInfo);
        }
    }
}
